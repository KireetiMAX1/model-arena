...
**Updated**: auto-updated by GitHub Actions on every push

| Rank | Model | Accuracy | F1 | ROC-AUC | CV ROC-AUC | Time (s) |
|------|-------|----------|----|---------|------------|----------|
| 🥇 | **Logistic Regression** | 0.9825 | 0.9861 | 0.9954 | 0.9957 ± 0.0048 | 0.03 |
| 🥈 | SVM (RBF) | 0.9825 | 0.9861 | 0.9950 | 0.9957 ± 0.0048 | 0.07 |
| 🥉 | Neural Network | 0.9649 | 0.9718 | 0.9937 | 0.9950 ± 0.0048 | 1.19 |
| 4 | Random Forest | 0.9561 | 0.9655 | 0.9932 | 0.9894 ± 0.0086 | 1.60 |
| 5 | XGBoost | 0.9474 | 0.9589 | 0.9927 | 0.9924 ± 0.0054 | 0.89 |
| 6 | Extra Trees | 0.9561 | 0.9655 | 0.9919 | 0.9942 ± 0.0041 | 1.02 |
| 7 | LightGBM | 0.9561 | 0.9655 | 0.9894 | 0.9922 ± 0.0053 | 0.92 |
| 8 | Gradient Boosting | 0.9474 | 0.9583 | 0.9891 | 0.9633 ± 0.0328 | 4.85 |
| 9 | Naive Bayes | 0.9298 | 0.9444 | 0.9868 | 0.9884 ± 0.0075 | 0.02 |
| 10 | K-Nearest Neighbors | 0.9561 | 0.9655 | 0.9788 | 0.9879 ± 0.0081 | 0.04 |
| 11 | Decision Tree | 0.9123 | 0.9286 | 0.9157 | 0.9179 ± 0.0201 | 0.05 |

*Primary metric: **ROC-AUC** on held-out test set. Best model: Logistic Regression at **0.9954**.*

![Model Comparison](assets/comparison_breast_cancer.png)
![Confusion Matrices](assets/confusion_breast_cancer.png)
![Feature Importance](assets/features_breast_cancer.png)
<!-- LEADERBOARD_END -->
