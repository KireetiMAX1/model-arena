...
**Updated**: 2026-05-21 01:10:03 UTC (commit `7ecf906`)

| Rank | Model | Accuracy | F1 | ROC-AUC | CV ROC-AUC | Time (s) |
|---|---|---|---|---|---|---|
| 🥇 | **Logistic Regression** | 0.9825 | 0.9861 | 0.9954 | 0.9957 | 1.8400 |
| 🥈 | SVM (RBF) | 0.9825 | 0.9861 | 0.9950 | 0.9957 | 0.0600 |
| 🥉 | Neural Network | 0.9649 | 0.9718 | 0.9937 | 0.9950 | 0.7800 |
...
| 8 | Gradient Boosting | 0.9474 | 0.9583 | 0.9891 | 0.9633 | 3.1900 |
